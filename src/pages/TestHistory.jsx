  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="shadow-sm"><CardContent className="p-4"><div className="text-sm text-slate-500">Overall Success Rate</div><div className="text-2xl font-bold">{stats.successRate}%</div></CardContent></Card>
        <Card className="shadow-sm"><CardContent className="p-4"><div className="text-sm text-slate-500">Total Visitors Tested</div><div className="text-2xl font-bold">{stats.totalVisitors.toLocaleString()}</div></CardContent></Card>
      </div>
      ...
      <div className="flex flex-col gap-3 mb-4">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
          ...
          <div className="ml-auto text-sm text-slate-600">
            Showing {Math.min(filtered.length, PAGE_SIZE)} of {filtered.length} filtered tests
          </div>
          <Button variant="outline" onClick={() => { setSearch(""); setStatusFilter("all"); setDateRange(undefined); setDateField("ended_date"); }}>
            Clear all filters
          </Button>
        </div>
      </div>
