...
export default function ResultsDashboard() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (dateRange.end) {
        filterCriteria.end_date_lte = dateRange.end.toISOString(); // Assuming end_date_lte filters based on test end date or started date
  ...
  useEffect(() => {
    fetchData();
  }, [fetchData, dateRange.start, dateRange.end]); // include fetchData
