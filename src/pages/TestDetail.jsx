      ...
      <div className="mb-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            {isWinnerPositive && (
              <div className="mt-4 mb-2 p-3 md:p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
            ...
            {!isWinnerPositive && approachingSig && (
              <div className="mt-4 mb-2 p-3 md:p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div className="flex items-start sm:items-center gap-3">
            ...
            {!isWinnerPositive && stagnating && (
              <div className="mt-4 mb-2 p-3 md:p-4 bg-amber-50 border border-amber-200 rounded-lg">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div className="flex items-start sm:items-center gap-3">
            ...
            {!isWinnerPositive && negativeCase.active && (
              <div className="mt-4 mb-2 p-3 md:p-4 bg-red-50 border border-red-200 rounded-lg">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div className="flex items-start sm:items-center gap-3">
